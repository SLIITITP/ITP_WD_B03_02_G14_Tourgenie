...
<div class="offcanvas offcanvas-start" style={{backgroundColor:'#3A1078',width:'200px', marginTop:'60px',color:'white'}} data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
  ...
  <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
    <a className="nav-link " id="v-pills-home-tab" data-toggle="pill" href="/" role="tab" aria-controls="v-pills-home" aria-selected="true"style={{color:'white'}}>Dash board</a>
    ...
    <a className="nav-link" id="v-pills-settings-tab" href="/Hotel" role="tab" aria-controls="v-pills-settings" aria-selected="false"style={{color:'white'}} onClick="showOffcanvas()">Hotel</a>
    
    <a className="nav-link" id="v-pills-settings-tab" href="/Tour" role="tab" aria-controls="v-pills-settings" aria-selected="false"style={{color:'white'}} onClick="showOffcanvas()">Tours</a>
    ...
    <a className="nav-link" id="v-pills-settings-tab" href="/package" role="tab" aria-controls="v-pills-settings" aria-selected="false"style={{color:'white'}} onClick="showOffcanvas()">Package</a>
  </div>
